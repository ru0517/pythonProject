...
Original file is located at
    https://colab.research.google.com/drive/16hwqWI2NwaXVoeMulut_RzFlpdGvUXsU
...
WorkInclass = float(input("Enter grade in class"))
Test = float(input("Enter grade in Test"))
Project = float(input("Enter grade in Project"))

score = 0.2 * WorkInclass + 0.3 * Test + 0.5 * Project
